...
Namespace Migrations
    ...
    Public NotInheritable Partial Class CreateManyToManyRelationshipFornecedores
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(CreateManyToManyRelationshipFornecedores))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202408230349140_CreateManyToManyRelationshipFornecedores"
            End Get
        End Property
